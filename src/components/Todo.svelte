...
<li class:editing class="todo">
  <div class="todo-item">
    <div>
      <!-- Example 3 of 3: #REACTIVE   -->

      <!-- Example 2 of 3: #PROPERTIES (using the function completeTodo and passing todo.id as a parameter)  -->
      <input
    ...
    <!-- Example 1 of 3: #PROPERTIES (using the function removeTodo and passing todo.id as a parameter)  -->
    <button
  ...
  <!-- Example 2 of 3: #CONTROLFLOW   -->
  {#if editing}
    <!-- Example 2 of 3: #REACTIVE   -->
    <!-- Example 3 of 3: #PROPERTIES (using the function handleEdit and passing event, todo.id as parameters)  -->
    <input
